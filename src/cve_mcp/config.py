...
class Settings(BaseSettings):
    ...
    # Fallback: bundled mirror at data/known_exploited_vulnerabilities.json
    # Updated daily by mirror-cisa-kev.yml (CISA blocks European datacenter IPs via Akamai)
